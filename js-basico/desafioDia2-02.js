...
let numeroEscolhido = Number(
  prompt("Digite um numero e tente adivinhar se o mesmo está correto!: ")
);
let tentativas = 0;
...
while (numeroEscolhido != numeroAleatorio) {
  if (numeroEscolhido > numeroAleatorio) {
    console.log(
      "O numero que voce digitou está MAIOR doque o numero a ser adivinhado"
    );
    numeroEscolhido = Number(prompt("\nVoce errou! Tente novamente!"));
  } else if (numeroEscolhido < numeroAleatorio) {
    console.log(
      "O numero que voce digitou está MENOR doque o numero a ser adivinhado"
    );
    numeroEscolhido = Number(prompt("\nVoce errou! Tente novamente!"));
  } else {
...
if (numeroEscolhido == numeroAleatorio) {
  console.log(
    "Parabéns! Você acertou o número a ser adivinhado!" +
      "\nVoce utilizou " +
      tentativas +
      "tentativas." +
